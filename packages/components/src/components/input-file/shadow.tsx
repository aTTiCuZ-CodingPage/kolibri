			...
			<Host class="kol-input-file">
				...
				>
					...
					<label slot="input" class="kol-input-file-label" htmlFor={this.state._id}>
						<div class={`kol-input-file-button ${this.state._disabled ? 'kol-input-file-button-disabled' : ''}`.trim()} aria-hidden="true">
							{this.state._multiple ? 'Dateien auswählen' : 'Datei auswählen'}
						</div>

						<div class={`kol-input-file-text ${this.state._disabled ? 'kol-input-file-text-disabled' : ''}`.trim()} aria-hidden="true">
